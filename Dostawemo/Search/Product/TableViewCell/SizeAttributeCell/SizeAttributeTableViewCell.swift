//
//  SizeAttributeTableViewCell.swift
//  Dostawemo
//
...
class SizeAttributeTableViewCell: UITableViewCell {
...
extension SizeAttributeTableViewCell: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.colorLabel.text = sizes[indexPath.row]
...
extension SizeAttributeTableViewCell: UICollectionViewDelegateFlowLayout {
    
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let width = sizes[indexPath.row].count > 10 ? CGFloat(230) : CGFloat(150)
